...
export class UserAddEditComponent implements OnInit {
  ...
  constructor(private dialogoReferencia: MatDialogRef<UserAddEditComponent>, private fb:FormBuilder, private _autService: AuthService, private _document: AuthService) {
